...
"""Command line entry points for the DKS Patch Builder."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m dks_patch_builder",
        description="Divinity II DKS Patch Builder",
    )
    parser.add_argument(
        "--version",
        action="version",
...
def _module_list() -> list[str]:
    return sorted(
        ...
        if name == "dks_patch_builder" or name.startswith("dks_patch_builder.")
    )
