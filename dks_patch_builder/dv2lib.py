...
#!/usr/bin/env python3
"""Shared DV2 reader/writer primitives for the DKS Patch Builder.

The module provides structural parsing, guarded in-memory edits and archive
serialization. Passing structural verification does not establish game-runtime
acceptance.
"""
