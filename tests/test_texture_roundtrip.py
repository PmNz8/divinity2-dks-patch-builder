...
from dks_patch_builder.codec.nif_texture import EXPECTED_NIF_HEADER_LINE, EXPECTED_NIF_VERSION, TEXTURE_BLOCK_TYPE, parse_texture_resource
from dks_patch_builder.codec.roundtrip import (
    MAX_SIDECAR_BYTES,
    SIDECAR_NAME,
    ChannelStatistics,
...
from dks_patch_builder.codec.png import encode_png_gray, encode_png_rgb
...
class TextureRoundTripFilesystemTests(unittest.TestCase):
    ...
    def test_export_is_atomic_refuses_overwrite_and_cleans_failed_staging(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with mock.patch("dks_patch_builder.codec.roundtrip.os.replace", side_effect=OSError("boom")):
                with self.assertRaises(TextureRoundTripError):
